...
import ule.chat.model.File;
import ule.chat.model.Session;
import ule.chat.model.Subject;
...
public abstract class _User extends BaseDataObject {
	...
	public static final Property<List<File>> FILES = Property.create("files", List.class);
	public static final Property<List<Session>> SESSIONS = Property.create("sessions", List.class);
	public static final Property<List<Subject>> SUBJECTS_OF_STUDENT = Property.create("subjectsOfStudent", List.class);
	public static final Property<List<Subject>> SUBJECTS_OF_TEACHER = Property.create("subjectsOfTeacher", List.class);
	...
	public void addToFiles(File obj) {
		addToManyTarget("files", obj, true);
	}

	public void removeFromFiles(File obj) {
		removeToManyTarget("files", obj, true);
	}

	@SuppressWarnings("unchecked")
	public List<File> getFiles() {
		return (List<File>) readProperty("files");
	}
	...
	public void addToSubjectsOfStudent(Subject obj) {
		addToManyTarget("subjectsOfStudent", obj, true);
	}

	public void removeFromSubjectsOfStudent(Subject obj) {
		removeToManyTarget("subjectsOfStudent", obj, true);
	}

	@SuppressWarnings("unchecked")
	public List<Subject> getSubjectsOfStudent() {
		return (List<Subject>) readProperty("subjectsOfStudent");
	}

	public void addToSubjectsOfTeacher(Subject obj) {
		addToManyTarget("subjectsOfTeacher", obj, true);
	}

	public void removeFromSubjectsOfTeacher(Subject obj) {
		removeToManyTarget("subjectsOfTeacher", obj, true);
	}

	@SuppressWarnings("unchecked")
	public List<Subject> getSubjectsOfTeacher() {
		return (List<Subject>) readProperty("subjectsOfTeacher");
	}
